...
The [second part](https://zwclose.github.io/2026/07/08/rtsper2.html) of the blog post is entirely dedicated to CVE-2022-25476, a vulnerability that allows access to the DMA controller. I explain how to access and program the controller from user mode to read and write physical memory. It also covers the disclosure timeline and research tools.
...
![pic](/images/realtek1/readcap.png)
...
![pic](/images/realtek1/poolof.png)
...
![pic](/images/realtek1/sensecopy.png)
...
![pic](/images/realtek1/arbwrite.png)
...
![pic](/images/realtek1/makesense.png)
...
<video style="padding-left: 0px; padding-right: 0px; width: 100%; height: auto"  class="wrapper" controls>
  <source src="/images/realtek1/poc.mp4" />
  <source src="/images/realtek1/poc.webm" />
...
This concludes the first part of the blog post. In the [second part](https://zwclose.github.io/2026/07/08/rtsper2.html), I will delve into accessing physical memory using the card reader's DMA capability. The code for all PoCs presented in the blog is available in the [repository](https://github.com/zwclose/realteksd). Feel free to ask me anything in [Twitter](https://twitter.com/zwclose).